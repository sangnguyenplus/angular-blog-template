...
tinymce.init({
    ...
    menu: {
        ...
        insert: {title: 'Insert', items: 'charmap hr anchor pagebreak insertdatetime'},
    ...
    plugins: [
         ...
         "searchreplace wordcount visualblocks code fullscreen insertdatetime media textcolor sh4tinymce"
    ],
	toolbar1: "undo redo | alignleft aligncenter alignright alignjustify | outdent indent  | link image media visualblocks | table | sh4tinymce code preview fullscreen",
	toolbar2: "formatselect | fontsizeselect | bold italic underline strikethrough subscript superscript | bullist numlist | forecolor backcolor",
    relative_urls: false,
    convert_urls: false,
	file_browser_callback: function(field, url, type, win) {
        tinyMCE.activeEditor.windowManager.open({
            file: '/public/plugins/kcfinder/browse.php?opener=tinymce4&field=' + field + '&type=' + type,
            title: 'KCFinder',
            width: 700,
            height: 500,
            inline: true,
